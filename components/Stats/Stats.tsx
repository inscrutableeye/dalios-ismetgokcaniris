...
const Stats: React.FC = () => {
  return (
    <div className='flex 2xl:flex-row lg:flex-row sm:flex-col  base:flex-col items-center justify-around 2xl:pt-36 lg:pt-36 sm:pt-32 2xl:px-28 lg:px-28 base:px-10 '>
