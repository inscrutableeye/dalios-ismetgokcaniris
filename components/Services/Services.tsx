      ...
      <span className='bg-servicesback rounded-tl-6xl flex items-start justify-start ml-32  '>
        <div className='flex flex-col'>
          ...
          <text className='text-text text-base font-normal leading-8 pl-9'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. A <br></br>{' '}
            consequat nunc id purus pretium sagittis. Nulla <br></br>
            ridiculus nullam bibendum luctus viverra. Eu pellentesque sem sed
            platea diam <br></br>dignissim duis purus.{' '}
          </text>
