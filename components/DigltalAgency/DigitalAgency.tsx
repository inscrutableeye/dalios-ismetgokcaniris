  ...
  return (
    ...
    >
      <div className='flex flex-col  '>
        <text
          className='2xl:text-5xl lg:text-5xl md:text-5xl base:text-base text-pcolor 2xl:pl-40 lg:pl-40 base:pl-10 font-semibold 2xl:leading-10
        lg:leading-10 base:leading-7 non-italic'
        >
          We are a creative <br></br>
          digital agency
        </text>

        <text className='text-xs text-pcolor 2xl:pl-40 2xl:pr-24 lg:pl-40 lg:pr-24 text-start base:pl-4 pt-10 leading-8 font-normal non-italic'>
        ...
        <button className='bg-heroButton pl-8 rounded-full py-5 self-start ml-40 mt-16 mb-96 '>
