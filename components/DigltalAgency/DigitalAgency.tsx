  ...
  return (
    <div className='flex flex-row '>
      <div className='flex flex-col'>
        ...
        <text className='text-xs text-pcolor pl-40 pr-24 pt-10 leading-8 font-normal non-italic'>
          Dalio started with a vision for building an agency to solve the
          business <br></br> problems of the future, and that requires a
          different model. <br></br>
          We’re not a branding agency that dabbles in tech, and we’re not a{' '}
          <br></br> development shop that leaves you hanging when it’s time{' '}
          <br></br>
          to go to market.
          <br></br>
          <br></br>
